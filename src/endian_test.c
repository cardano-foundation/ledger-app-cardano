...
void run_endian_test()
{
	...
	u1be_write(buffer2 + 1, 0x74);
	EXPECT_EQ(u1be_read(buffer2), 0x44);
	EXPECT_EQ(u1be_read(buffer2 + 1), 0x74);
	EXPECT_EQ(u1be_read(buffer2 + 2), 0x47);


	u2be_write(buffer2 + 1, 0x2345);
	EXPECT_EQ(u1be_read(buffer2), 0x44);
	EXPECT_EQ(u2be_read(buffer2 + 1), 0x2345);
	EXPECT_EQ(u1be_read(buffer2 + 3), 0x47);

	u4be_write(buffer2 + 1, 0x32547698);
	EXPECT_EQ(u1be_read(buffer2), 0x44);
	EXPECT_EQ(u4be_read(buffer2 + 1), 0x32547698);
	EXPECT_EQ(u1be_read(buffer2 + 5), 0x47);

	u8be_write(buffer2 + 1, 0xa0b1c2d300112233);
	EXPECT_EQ(u1be_read(buffer2), 0x44);
	EXPECT_EQ(u8be_read(buffer2 + 1), 0xa0b1c2d300112233);
	EXPECT_EQ(u1be_read(buffer2 + 9), 0x77);
}
